...
import SubmissionsContainer from '@/components/workspace/pages/creator/submissions/submissions-container'
            ...
            try {
                ...
                if (data && data.length > 0) {
                    ...
                    const formattedSubmissions: ISubmissionItem[] = data.map((item) => ({
                        ...
                        submissionDetailsLink:`/app/accounts/creator/submissions/${item.id}`
                    }))
