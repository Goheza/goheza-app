...
import SearchItem from '@/components/workspace/pages/creator/search-item'
import CampaignCard, { ICampaignCard } from '@/components/workspace/pages/creator/opportunities-card'
import { useEffect, useState } from 'react'
import { ISubmissionItem } from '@/components/workspace/pages/creator/submissions/submission-item'
import { supabaseClient } from '@/lib/supabase/client'
import { useRouter } from 'next/navigation'
import NoCampaignsBanner from '@/components/workspace/pages/creator/no-campaign'
