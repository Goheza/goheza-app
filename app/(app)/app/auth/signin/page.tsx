...
import { signInUser, signInWithGoogle } from '@/lib/supabase/auth/authHelpers'
...
export default function WorkspaceSignIn() {
    ...
    useEffect(() => {
        const intializeAuthCheckUp = async () => {
            try {
            ...
            <div className="w-full max-w-md p-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="mt-2 text-right">
                        <Link
                            href="/app/auth/passwords/forgot-password"
