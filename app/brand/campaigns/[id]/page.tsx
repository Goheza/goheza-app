        ...
        <div className="font-sans p-5 max-w-6xl mx-auto">
            <div className="mb-8 flex items-center justify-between">
                ...
                {campaign.status !== 'cancelled' && (
                    <button
                        ...
                        disabled={cancelling}
                        className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg font-medium shadow-sm transition disabled:opacity-50"
                    >
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border mb-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div></div>
                    <div>
                        <h2 className="text-xl font-semibold mb-4">Quality Standard</h2>
