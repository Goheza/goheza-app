...
export default function HeaderItemBrand() {
    ...
    const navLinks = [
        { name: 'Dashboard', href: '/app/accounts/brand/dashboard' },
        { name: 'Campaigns', href: '/app/accounts/brand/campaigns' },
        { name: 'Support', href: '/app/accounts/brand/support' },
        { name: 'Settings', href: '/app/accounts/brand/profile' },
        { name: 'Analytics', href: '/app/accounts/brand/analytics' },
