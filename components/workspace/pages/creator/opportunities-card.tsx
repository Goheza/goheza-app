 ...
 * Displays a campaign preview card linking to /app/accounts/creator/campaign/[id]
 */
...
export default function CampaignCard({
    ...
    return (
        <Link
            href={`/app/accounts/creator/campaign/${campaignSourceID}`}
            className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-shadow"
        >
            <div className="h-32 w-full relative">
                <Image src={campaignImageSource || fallbackImage} alt={campaignName} fill className="object-cover" />
            </div>
            <div className="p-4">
