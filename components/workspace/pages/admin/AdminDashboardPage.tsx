    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            ...
            try {
                ...
                // Note: The `.gt('created_at', yesterday)` filter is commented out in the original code,
                // so the current logic fetches ALL users. Keeping the same logic for consistency.
        ...
        <div className="p-8 space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
                <MetricCard
                    ...
                    description="Total Users (Unfiltered)"
                />
                <MetricCard
            ...
            {/* ⭐ MODIFIED: Grid updated to 4 columns on medium screens and up */}
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Link href="/app/admin/campaign-management">
                    <Button className="w-full h-auto py-4 bg-[#e85c51] hover:bg-[#f3867e] text-white">
                        Review Campaigns
                    </Button>
                </Link>

                {/* ⭐ NEW BUTTON: Check out campaign submissions */}
                <Link href="/app/admin/campaign-submission">
                ...
                <Link href="/app/admin/notifications">
                    <Button className="w-full h-auto py-4 bg-gray-100 text-neutral-800 border hover:bg-gray-200">
                        View Notifications
                    </Button>
                </Link>
